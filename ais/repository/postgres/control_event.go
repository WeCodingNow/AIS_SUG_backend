...
func (s *repoControlEvent) Fill(scannable Scannable) {
...
func (c repoControlEvent) GetDescription() ModelDescription {
		...
		Dependencies: []ModelDependency{
			{
				...
				ModelMaker:      func() RepoModel { return NewRepoSemester() },
			},
			{
				DependencyType:  ManyToOne,
				ForeignKeyField: controlEventControlEventTypeFK,
				ModelMaker:      func() RepoModel { return NewRepoControlEventType() },
			},
			{
				DependencyType:  ManyToOne,
				ForeignKeyField: controlEventDisciplineFK,
				ModelMaker:      func() RepoModel { return NewRepoDiscipline() },
			},
			{
...
func (r *DBAisRepository) GetControlEvent(ctx context.Context, id int) (*models.ControlEvent, error) {
	...
	filler, err := MakeFiller(ctx, r.db, controlEventFields, controlEventTable, &id)
...
func (r *DBAisRepository) GetAllControlEvents(ctx context.Context) ([]*models.ControlEvent, error) {
	...
	filler, err := MakeFiller(ctx, r.db, controlEventFields, controlEventTable, nil)
