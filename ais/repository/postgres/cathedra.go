...
func (c *repoCathedra) Fill(scannable Scannable) {
...
func (c repoCathedra) GetDescription() ModelDescription {
...
func (r *DBAisRepository) GetCathedra(ctx context.Context, id int) (*models.Cathedra, error) {
	...
	filler, err := MakeFiller(ctx, r.db, cathedraFields, cathedraTable, &id)
...
func (r *DBAisRepository) GetAllCathedras(ctx context.Context) ([]*models.Cathedra, error) {
	...
	filler, err := MakeFiller(ctx, r.db, cathedraFields, cathedraTable, nil)
